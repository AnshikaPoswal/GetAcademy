...
<?php 
        $query = "SELECT * FROM `team` WHERE name = 'Anshika'";
...
?>
							...
							<div class="team team-list clearfix">
								...
								<div class="team-desc">
									<div class="team-title"><h4>James</h4><span>Chairman</span></div>
...
<?php 
        $query = "SELECT * FROM `team` WHERE name = 'Anshika Poswal'";
...
?>
						...
						<div class="col-md-6 bottommargin">
							...
							<div class="team team-list clearfix">
								...
								<div class="team-desc">
									<div class="team-title"><h4>Anshika</h4><span>CEO</span></div>
					...
					<?php 
        $query = "SELECT * FROM `team` WHERE name != 'Anshi' AND name != 'Anshi Poswal' ";
